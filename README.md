...
## © Copyright
All content included on the Q Amyloid Site, such as text, graphics, logos, button icons, images, page layout and underlying code are the property of ?. By continuing to use the site you acknowledge that such contents are protected by copyright, trademarks, database rights and other intellectual property rights. You can only use our copyrights or any of the content from the website with our prior written permission.

## 📜 License
[Insert the chosen license here, e.g., MIT, GPL, or proprietary]
